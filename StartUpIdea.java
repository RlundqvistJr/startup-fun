public class StartUpIdea implements Comparable<StartUpIdea> {
     ...
     * @param unfair the unfair advantage you as a founder have
     */
    public StartUpIdea(String problem, String targetCustomer,
                       int customerNeed, int knownPeopleWithProblem,
                       int targetMarketSize, String competitors, String unfair) {
    ...
    public int compareTo(StartUpIdea other) {
        ...
        if (this.unfair.length() <= 10) { //If the idea can't elaborate much of an unfair advantage,
            // then they are less desirable
            totalCustomerDesireDiff += 100;
        }
     ...
     * @param unfair to set
     */
    public void setUnfair(String unfair) {
        this.unfair = unfair;
    }
